"""
Django settings for mytestapp11_7 project.
...
ROOT_URLCONF = 'mytestapp11_7.urls'
...
WSGI_APPLICATION = 'mytestapp11_7.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "MyTestApp11 Support <support@mytestapp11-7.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "mytestapp11_7 API",
    "DESCRIPTION": "API documentation for mytestapp11_7 App",
    "VERSION": "v1",
}
